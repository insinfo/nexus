...
@Component(
  selector: 'operacao-page',
  templateUrl: 'operacao_page.html',
  styleUrls: <String>['operacao_page.css'],
  directives: <Object>[
    coreDirectives,
    DatatableComponent,
    NgFlowComponent,
...
class OperacaoPage implements OnInit {

  Iterable<TipoFluxo> get tiposFluxoDisponiveis => TipoFluxo.values;
  ...
  String currentSection = 'operacao';
